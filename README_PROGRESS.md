...
- [x] Step30 名言を普遍化: 信仰がない人にも響くよう20件の聖句を口語訳から選び直し(人物と出典のゆかりは保持=各人物ゆかりの書からのみ選択)。例: モーセ=申命記30:19命を選べ/ヨシュア=1:8継続・24:15自ら選べ/サムエル=傾聴/ダビデ=詩30:5夕べ涙朝喜び・詩34:18心砕けた者に近い/ソロモン=箴15:1柔らかい答・伝道3:1時/イザヤ=40:31新たな力・41:6助け合い/ダニエル=12:3知恵で人を導く星/ペテロ=Iペテロ3:8心を一つに/パウロ=ローマ12:21善で悪に勝て・愛の賛歌/イエス=重荷を負う者来たれ・平安。全て本文をweb検索で口語訳確認済。bio/eraDescriptionは人物単位で変更なし。
...
- [x] Step23 全画面背景: 当時のイスラエル街並み画像(public/brand/bg.jpg 244KB)をbody固定背景に。body::beforeで羊皮紙62%オーバーレイを重ね可読性確保(本文はz-1で前面)。PVサムネをRE:BIBLE聖書ビジュアル(public/pv/thumbnail.jpg)に差替・軽量化
...
NEXT TASK: 変更分(src/data/quotes.ts のみ)をcommit&push→再デプロイ。前回までの未push分(タイトル/円運動/背景/ボーナス等)があれば一緒に反映。気になる聖句があれば人物ゆかりの書の範囲で再調整可。